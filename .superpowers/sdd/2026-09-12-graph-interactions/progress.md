...
Task 8: final whole-branch review CHANGES REQUESTED -> one fix wave (ee8fb72: drag datum join, tooltip css-px scaling, GraphCanvas component tests happy-dom+RTL, declared d3-selection/d3-transition deps, Enter/Escape search) -> scoped re-review: all 5 findings ADDRESSED, no new breakage. Suites: vitest 114/114, typecheck clean, build+smoke 200.
